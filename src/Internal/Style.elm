...
classes =
    ...
    , text = "elmui-t"
    , grid = "elmui-g"
    , imageContainer = "elmui-ic"
    , wrapped = "elmui-wrp"

    -- widhts/heights
    , widthFill = "elmui-wf"
    , widthContent = "elmui-wc"
    , widthExact = "elmui-we"
    , widthFillPortion = "elmui-wfp"
    , heightFill = "elmui-hf"
    , heightContent = "elmui-hc"
    , heightExact = "elmui-he"
    , heightFillPortion = "elmui-hfp"
    , seButton = "elmui-sbt"
    ...
    -- alignments
    , alignTop = "elmui-at"
    , alignBottom = "elmui-ab"
    , alignRight = "elmui-ar"
    , alignLeft = "elmui-al"
    , alignCenterX = "elmui-cx"
    , alignCenterY = "elmui-cy"
    , alignedHorizontally = "elmui-ah"
    , alignedVertically = "elmui-av"

    -- space evenly
    , spaceEvenly = "elmui-sev"
    , container = "elmui-ctr"
    , alignContainerRight = "elmui-acr"
    , alignContainerBottom = "elmui-acb"
    , alignContainerCenterX = "elmui-accx"
    , alignContainerCenterY = "elmui-accy"

    -- content alignments
    , contentTop = "elmui-ct"
    , contentBottom = "elmui-cb"
    , contentRight = "elmui-cr"
    , contentLeft = "elmui-cl"
    , contentCenterX = "elmui-ccx"
    , contentCenterY = "elmui-ccy"

    -- selection
    , noTextSelection = "elmui-notxt"
    , cursorPointer = "elmui-cptr"
    , cursorText = "elmui-ctxt"

    -- pointer events
    , passPointerEvents = "elmui-ppe"
    , capturePointerEvents = "elmui-cpe"
    , transparent = "elmui-clr"
    , opaque = "elmui-oq"
    , overflowHidden = "elmui-oh"
    ...
    , focus = "elmui-fcs"
    , focusedWithin = "elmui-focus-within"
    ...
    --scrollbars
    , scrollbars = "elmui-sb"
    , scrollbarsX = "elmui-sbx"
    , scrollbarsY = "elmui-sby"
    , clip = "elmui-cp"
    , clipX = "elmui-cpx"
    , clipY = "elmui-cpy"
    ...
    -- borders
    , borderNone = "elmui-bn"
    , borderDashed = "elmui-bd"
    , borderDotted = "elmui-bdt"
    , borderSolid = "elmui-bs"

    -- text weight
    , sizeByCapital = "elmui-cap"
    , fullSize = "elmui-fs"
    , textThin = "elmui-w1"
    , textExtraLight = "elmui-w2"
    , textLight = "elmui-w3"
    , textNormalWeight = "elmui-w4"
    , textMedium = "elmui-w5"
    , textSemiBold = "elmui-w6"
    , bold = "elmui-w7"
    , textExtraBold = "elmui-w8"
    , textHeavy = "elmui-w9"
    , italic = "elmui-i"
    , strike = "elmui-sk"
    , underline = "elmui-u"
    , textUnitalicized = "elmui-tun"

    -- text alignment
    , textJustify = "elmui-tj"
    , textJustifyAll = "elmui-tja"
    , textCenter = "elmui-tc"
    , textRight = "elmui-tr"
    , textLeft = "elmui-tl"
    , transition = "elmui-ts"
    ...
    -- inputText
    , inputText = "elmui-it"
    , inputMultiline = "elmui-iml"
    , inputMultilineParent = "elmui-imlp"
    , inputMultilineFiller = "elmui-imlf"
    , inputMultilineWrapper = "elmui-implw"
    , inputLabel = "elmui-lbl"
